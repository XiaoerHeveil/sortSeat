...
- 参数依次为：学生名单文件、规则文件、座位列数、每组列数。这其中规则文件是可选的。
...
### 1. 目前设置规则不够直观，后续提供更简单的方法

### 2. 自定义标题栏在鼠标拖动时无法实时更新位置，目前的解决方案是松开后一并计算

### 3. 目前对于前端的个性化设置在关闭后无法保存

### 4. 目前有些规则无法按照预期工作

## 关于测试使用的学生信息文件

这些文件内的所有学生信息全部都是作者**胡编乱造**的，若您感到被冒犯，请联系作者删除。
